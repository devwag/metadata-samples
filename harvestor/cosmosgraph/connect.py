...
try:
    client = client.Client('wss://accnt-cosmosgraph.gremlin.cosmos.azure.com:443/', 'g',
                           username="/dbs/sample-database/colls/python-graph",
                           password="tV6NT4pgpqvE3mioro0DDlBDokaDl4taW64G0xlOj9awvyAX49aSJv9tXElEEtrIeBNxLbbTnY2e7iAn2VqjSA==",
